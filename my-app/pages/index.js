...
export default function Home() {
  ...
  const getNumProposalsInDAO = async () => {
    try {
      const provider = await getProviderOrSigner();
      const contract = getDaoContractInstance(provider); // Why no await here?
  ...
  // Calls the 'executeProposal' function in the contract, using passed proposal ID
  ...
  // re-fetch all proposals in DAO when user switches to the 'View Proposal' tab
  useEffect(() => {
